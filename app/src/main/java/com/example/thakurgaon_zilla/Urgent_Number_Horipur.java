...
public class Urgent_Number_Horipur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Urgent_Number_Horipur.MyAdapter myAdapter = new Urgent_Number_Horipur.MyAdapter();
        ...
        getSupportActionBar().setTitle("হরিপুরের নাম্বারসমূহ");
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            //********************************************
            Animation animation = AnimationUtils.loadAnimation(Urgent_Number_Horipur.this, R.anim.kartik_anim);
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE)!=
                        ...
                        Toast.makeText(Urgent_Number_Horipur.this,"please grant permission",Toast.LENGTH_SHORT).show();
                        requestPermission();
                    }
                    else{
    ...
    private  void  requestPermission(){
        ActivityCompat.requestPermissions(Urgent_Number_Horipur.this,new String[]
